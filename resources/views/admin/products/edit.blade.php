                        ...
                        <div class="card-body">
                            <form action="{{ route('products.update', $product->id_product) }}" method="POST"
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_brand') is-invalid @enderror" id="id_brand"
                                        ...
                                        @foreach ($brands as $id => $brand_name)
                                            <option value="{{ $id }}"
                                                {{ $product->id_brand == $id ? 'selected' : '' }}>{{ $brand_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('id_brand')
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control @error('id_category') is-invalid @enderror" id="id_category"
                                        ...
                                        @foreach ($categories as $id => $category_name)
                                            <option value="{{ $id }}"
                                                {{ $product->id_category == $id ? 'selected' : '' }}>{{ $category_name }}
                                            </option>
                                        @endforeach
                                    </select>
                                    @error('id_category')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea class="form-control @error('description') is-invalid @enderror" id="summernote" name="description">{{ $product->description }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="number" step="0.01"
                                        ...
                                        name="rental_price" value="{{ $product->rental_price }}" required>
                                    @error('rental_price')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
